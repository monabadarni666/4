...
public class Point2D{
	...
	public void scale(Point2D cen, double ratio) {
		//////////add your code below ///////////
        this._x = cen.x() + (this._x - cen.x()) * ratio;
        this._y = cen.y() + (this._y - cen.y()) * ratio;
		/////////////////////////////////////////
	}
	public void rotate(Point2D cen, double angleDegrees) {
		//////////add your code below ///////////
        double angleRadians = Math.toRadians(angleDegrees);
        double x = this._x - cen.x();
        double y = this._y - cen.y();
        this._x = cen.x() + x * Math.cos(angleRadians) - y * Math.sin(angleRadians);
        this._y = cen.y() + x * Math.sin(angleRadians) + y * Math.cos(angleRadians);
		/////////////////////////////////////////
	}
}
